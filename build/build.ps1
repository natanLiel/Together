...
Once8 '              <div style="display:flex;align-items:baseline;justify-content:space-between;gap:12px">' + "`n" + '                <span style="font-family:var(--font-heading);font-size:22px">Preferences</span>' '              <div style="display:flex;align-items:center;justify-content:space-between;gap:10px">' + "`n" + '                <sc-if value="{{ prefsHasBack }}"><button class="tgp-back tg-tap" aria-label="Back" sc-camel-on-click="{{ prefsGoBack }}"><svg width="19" height="19" sc-camel-view-box="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M15 5l-7 7 7 7"></path></svg></button></sc-if>' + "`n" + '                <span style="font-family:var(--font-heading);font-size:22px;flex:1;min-width:0">Preferences</span>' 'preferences back arrow'
...
Once8 '</helmet>' '<style>.tgp-back{flex:none;width:36px;height:36px;margin-inline-start:-6px;display:grid;place-items:center;border-radius:999px;cursor:pointer;color:#F2EAE6;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12);box-shadow:inset 0 1px 0 rgba(255,255,255,.08)}[dir=rtl] .tgp-back svg{transform:scaleX(-1)}</style></helmet>' 'preferences back arrow style'
