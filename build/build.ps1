...
# the profile blur starts at the distance line
Once8 '</helmet>' '<style>.tgd-hero::after{display:none}.tgd-hero-info::before{content:"";position:absolute;z-index:-1;left:-20px;right:-80px;top:34px;bottom:-28px;pointer-events:none;-webkit-backdrop-filter:blur(7px);backdrop-filter:blur(7px);-webkit-mask-image:linear-gradient(180deg,rgba(0,0,0,0),#000 38px);mask-image:linear-gradient(180deg,rgba(0,0,0,0),#000 38px)}</style></helmet>' 'profile blur height'
