...
$css31 = '<style>' +
  ...
  '@keyframes tgs-halo{0%{opacity:0}30%{opacity:.5}54%{opacity:.5}72%,100%{opacity:0}}' +
  '@keyframes tgs-merge{0%,38%{opacity:0;transform:scale(.99)}' +
  '48%{opacity:.5;transform:scale(1.07)}' +
...
# ── the sign-up buttons: one pill shape, and the real Apple and Google buttons ──
Once8 '<div style="display:flex;flex-direction:column;gap:16px">' '<div class="tg-authbtns" style="display:flex;flex-direction:column;gap:14px"><style>.tg-authbtns .btn,.tg-authbtns .tg-sso{height:56px !important;border-radius:999px !important;width:100%;box-sizing:border-box;margin:0}.tg-sso{display:flex;align-items:center;justify-content:center;gap:10px;padding:0 20px;cursor:pointer;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Text",Roboto,"Segoe UI",Helvetica,Arial,sans-serif;font-weight:500;font-size:16px;letter-spacing:0;line-height:1;background:#FFFFFF;color:#000000;border:1px solid #FFFFFF;-webkit-appearance:none;appearance:none}.tg-sso-google{color:#1F1F1F;border-color:#747775}.tg-sso svg{display:block}.tg-sso-apple svg{position:relative;top:-1px}</style>' 'auth buttons wrapper'
Once8 '<div style="display:flex;gap:13px">' '<div style="display:flex;flex-direction:column;gap:14px">' 'social row stacks'
Once8 '                  <button class="tg-social tg-imgbtn tg-imgbtn-apple tg-tap tg-cased" style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px;height:52px;font-family:var(--font-heading);font-size:15.5px;cursor:pointer" sc-camel-on-click="{{ go.basics }}">' + "`n" + '                    <svg width="13" height="15" sc-camel-view-box="0 0 814 1000" fill="#1C2536" style="flex:none"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-163.9-39.5c-76.4 0-103.5 40.8-165.9 40.8s-105.6-57-155.5-127C46.7 790.7 0 663 0 541.8c0-194.4 126.4-297.5 250.8-297.5 66.1 0 121.2 43.4 162.7 43.4 39.5 0 101.1-46 176.3-46 28.5 0 130.9 2.6 198.3 99.2zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z"></path></svg>' + "`n" + '                    <span>Apple</span>' + "`n" + '                  </button>' '                  <button class="tg-sso tg-sso-apple tg-tap" sc-camel-on-click="{{ go.basics }}">' + "`n" + '                    <svg width="15" height="18" sc-camel-view-box="0 0 814 1000" fill="#000" style="flex:none"><path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-163.9-39.5c-76.4 0-103.5 40.8-165.9 40.8s-105.6-57-155.5-127C46.7 790.7 0 663 0 541.8c0-194.4 126.4-297.5 250.8-297.5 66.1 0 121.2 43.4 162.7 43.4 39.5 0 101.1-46 176.3-46 28.5 0 130.9 2.6 198.3 99.2zm-234-181.5c31.1-36.9 53.1-88.1 53.1-139.3 0-7.1-.6-14.3-1.9-20.1-50.6 1.9-110.8 33.7-147.1 75.8-28.5 32.4-55.1 83.6-55.1 135.5 0 7.8 1.3 15.6 1.9 18.1 3.2.6 8.4 1.3 13.6 1.3 45.4 0 102.5-30.4 135.5-71.3z"></path></svg>' + "`n" + '                    <span>Continue with Apple</span>' + "`n" + '                  </button>' 'apple button'
Once8 '                  <button class="tg-social tg-imgbtn tg-imgbtn-google tg-tap tg-cased" style="flex:1;display:flex;align-items:center;justify-content:center;gap:8px;height:52px;font-family:var(--font-heading);font-size:15.5px;cursor:pointer" sc-camel-on-click="{{ go.basics }}">' + "`n" + '                    <svg width="15" height="15" sc-camel-view-box="0 0 18 18" style="flex:none"><path fill="#4285F4" d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844a4.14 4.14 0 0 1-1.796 2.716v2.259h2.908c1.702-1.567 2.684-3.874 2.684-6.615z"></path><path fill="#34A853" d="M9 18c2.43 0 4.467-.806 5.956-2.184l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332C2.438 15.983 5.482 18 9 18z"></path><path fill="#FBBC05" d="M3.964 10.706A5.41 5.41 0 0 1 3.682 9c0-.593.102-1.17.282-1.706V4.962H.957A8.996 8.996 0 0 0 0 9c0 1.452.348 2.827.957 4.038l3.007-2.332z"></path><path fill="#EA4335" d="M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0 5.482 0 2.438 2.017.957 4.962L3.964 7.294C4.672 5.167 6.656 3.58 9 3.58z"></path></svg>' + "`n" + '                    <span>Google</span>' + "`n" + '                  </button>' '                  <button class="tg-sso tg-sso-google tg-tap" sc-camel-on-click="{{ go.basics }}">' + "`n" + '                    <svg width="20" height="20" sc-camel-view-box="0 0 18 18" style="flex:none"><path fill="#4285F4" d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844a4.14 4.14 0 0 1-1.796 2.716v2.259h2.908c1.702-1.567 2.684-3.874 2.684-6.615z"></path><path fill="#34A853" d="M9 18c2.43 0 4.467-.806 5.956-2.184l-2.908-2.259c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332C2.438 15.983 5.482 18 9 18z"></path><path fill="#FBBC05" d="M3.964 10.706A5.41 5.41 0 0 1 3.682 9c0-.593.102-1.17.282-1.706V4.962H.957A8.996 8.996 0 0 0 0 9c0 1.452.348 2.827.957 4.038l3.007-2.332z"></path><path fill="#EA4335" d="M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0 5.482 0 2.438 2.017.957 4.962L3.964 7.294C4.672 5.167 6.656 3.58 9 3.58z"></path></svg>' + "`n" + '                    <span>Continue with Google</span>' + "`n" + '                  </button>' 'google button'
Once8 '    "Google": "גוגל",' '    "Google": "גוגל",' + "`n" + '    "Continue with Apple": "המשך עם Apple",' + "`n" + '    "Continue with Google": "המשך עם Google",' 'sso copy in hebrew'
# the Apple and Google buttons sit side by side, a little smaller
Once8 '.tg-sso-apple svg{position:relative;top:-1px}</style>' '.tg-sso-apple svg{position:relative;top:-1px}.tg-authbtns .tg-ssorow .tg-sso{height:48px !important;flex:1 1 0;width:auto;min-width:0;padding:0 12px;gap:8px;font-size:15px}.tg-ssorow .tg-sso-apple svg{width:13px;height:16px}.tg-ssorow .tg-sso-google svg{width:17px;height:17px}</style>' 'sso row styles'
Once8 '<div style="display:flex;flex-direction:column;gap:14px">' '<div class="tg-ssorow" style="display:flex;gap:12px">' 'sso side by side'
Once8 '<span>Continue with Apple</span>' '<span>Apple</span>' 'apple label'
Once8 '<span>Continue with Google</span>' '<span>Google</span>' 'google label'
Once8 '    "Apple": "אפל",' + "`n" + '    "Google": "גוגל",' + "`n" + '    "Continue with Apple": "המשך עם Apple",' + "`n" + '    "Continue with Google": "המשך עם Google",' '    "Apple": "Apple",' + "`n" + '    "Google": "Google",' 'brand names stay in latin'
# a returning user sees the splash play without its button, then lands in Discover
Once8 '    screen: ''splash'', tab: ''discover'', overlay: null,' + "`n" + '' '    screen: ''splash'', tab: ''discover'', overlay: null,' + "`n" + '    returning: (() => { try { return localStorage.getItem(''tg-signed-in'') === ''1''; } catch (e) { return false; } })(),' + "`n" + '' 'returning users are remembered'
Once8 '    this.tick = setInterval(() => this.onTick(), 1000); this.applyLang(); this.applyAccent(); this.applyWheels();' + "`n" + '  }' + "`n" + '' '    this.tick = setInterval(() => this.onTick(), 1000); this.applyLang(); this.applyAccent(); this.applyWheels();' + "`n" + '    // someone already signed in watches the splash play, then lands in Discover' + "`n" + '    if (this.state.returning) this._autoOpen = setTimeout(() => {' + "`n" + '      if (this.state.screen === ''splash'') this.nav(''discover'', { tab: ''discover'', returning: false });' + "`n" + '      else this.setState({ returning: false });' + "`n" + '    }, 3300);' + "`n" + '  }' + "`n" + '' 'returning splash opens discover'
Once8 '  componentDidUpdate() { this.applyLang(); this.applyAccent(); this.applyWheels(); this.qSync(); this.toTop(); }' + "`n" + '' '  componentDidUpdate() { this.applyLang(); this.applyAccent(); this.applyWheels(); this.qSync(); this.toTop(); this.rememberSignIn(); }' + "`n" + '  // reaching the app itself counts as signed in, until log out or delete' + "`n" + '  rememberSignIn() {' + "`n" + '    if (this._signedIn || [''discover'', ''likes'', ''together'', ''prefs'', ''profile'', ''chat''].indexOf(this.state.screen) < 0) return;' + "`n" + '    this._signedIn = true;' + "`n" + '    try { localStorage.setItem(''tg-signed-in'', ''1''); } catch (e) {}' + "`n" + '  }' + "`n" + '  signOut() {' + "`n" + '    clearTimeout(this._autoOpen); this._signedIn = false;' + "`n" + '    try { localStorage.removeItem(''tg-signed-in''); } catch (e) {}' + "`n" + '    this.nav(''splash'', { returning: false });' + "`n" + '  }' + "`n" + '' 'remember and forget sign-in'
Once8 '  componentWillUnmount() { clearInterval(this.tick); }' '  componentWillUnmount() { clearInterval(this.tick); clearTimeout(this._autoOpen); }' 'clear auto-open timer'
Once8 '      stillGround: [''splash'', ''auth'', ''login'', ''otp''].indexOf(screen) >= 0 ? ''on'' : '''',' + "`n" + '' '      stillGround: [''splash'', ''auth'', ''login'', ''otp''].indexOf(screen) >= 0 ? ''on'' : '''',' + "`n" + '      splashManual: !st.returning,' + "`n" + '' 'splash button only for new visitors'
Once8 '              <div data-tgs-rise="1" style="position:relative;display:flex;flex-direction:column;gap:10px;width:100%;max-width:302px;flex:none;animation:tg-rise .91s 2.52s cubic-bezier(.2,.8,.2,1) both">' + "`n" + '                <button class="btn btn-primary tg-tap tg-cased" style="height:56px;font-family:var(--font-body);font-size:15px" sc-camel-on-click="{{ go.auth }}">Open app</button>' + "`n" + '              </div>' + "`n" + '' '              <sc-if value="{{ splashManual }}">' + "`n" + '              <div data-tgs-rise="1" style="position:relative;display:flex;flex-direction:column;gap:10px;width:100%;max-width:302px;flex:none;animation:tg-rise .91s 2.52s cubic-bezier(.2,.8,.2,1) both">' + "`n" + '                <button class="btn btn-primary tg-tap tg-cased" style="height:56px;font-family:var(--font-body);font-size:15px" sc-camel-on-click="{{ go.auth }}">Open app</button>' + "`n" + '              </div>' + "`n" + '              </sc-if>' + "`n" + '' 'wrap open app button'
Once8 '{ label: ''Log out'', meta: '''', onClick: () => this.nav(''splash'') }' '{ label: ''Log out'', meta: '''', onClick: () => this.signOut() }' 'log out forgets'
Once8 'deleteAccount: () => { this.toast(''Account deleted. Signed out.''); this.nav(''splash''); },' 'deleteAccount: () => { this.toast(''Account deleted. Signed out.''); this.signOut(); },' 'delete forgets'
# the app opens on its own dark ground, never on the raw template
Once8 '<meta name="viewport" content="width=device-width, initial-scale=1">' + "`n" + '' '<meta name="viewport" content="width=device-width, initial-scale=1">' + "`n" + '<style>html{background:#120C12}html:not(.tg-ready) body{visibility:hidden}</style>' + "`n" + '<script>setTimeout(function(){document.documentElement.classList.add(''tg-ready'')},6000)</script>' + "`n" + '' 'blank until first render'
Once8 '    this.tick = setInterval(() => this.onTick(), 1000); this.applyLang(); this.applyAccent(); this.applyWheels();' + "`n" + '' '    this.tick = setInterval(() => this.onTick(), 1000); this.applyLang(); this.applyAccent(); this.applyWheels();' + "`n" + '    // the page stays blank until the first real frame, so the raw template never shows' + "`n" + '    requestAnimationFrame(() => document.documentElement.classList.add(''tg-ready''));' + "`n" + '' 'reveal on first render'
# sign-up verifies the phone number first: one number, one account
Once8 '</helmet>' '<style>.tgn .sc-interp{font:inherit !important;color:inherit !important;letter-spacing:inherit !important;background:none !important;border:0 !important;padding:0 !important}.tgn{min-height:100%;display:flex;flex-direction:column;padding:34px var(--space-6) var(--space-6);padding-block-end:28px;box-sizing:border-box}.tgn-head{display:flex;align-items:center;gap:10px;margin-bottom:24px}.tgn-head img{display:block;width:36px;height:auto}.tgn-kicker{font-family:var(--font-meta);font-weight:600;font-size:10px;letter-spacing:.2em;color:rgba(242,234,230,.66)}.tgn-h{font-family:var(--font-heading);font-size:42px;line-height:1.08;margin:0}.tgn-lede{font-family:var(--font-body);font-size:15.5px;line-height:1.62;color:rgba(242,234,230,.68);margin:20px 0 0;text-wrap:pretty}.tgn-field{margin-top:34px;display:flex;flex-direction:column;gap:8px}.tgn-field label{font-family:var(--font-body);font-style:italic;font-size:14px;color:rgba(242,234,230,.66)}.tgn-row{display:flex;gap:10px}.tgn-cc,.tgn-in,.tgn-cell{background:rgba(255,255,255,.055);border:1px solid rgba(255,255,255,.12);box-shadow:inset 0 1px 0 rgba(255,255,255,.08);color:#F2EAE6;box-sizing:border-box;transition:border-color .2s ease,background-color .2s ease,box-shadow .2s ease}.tgn-cc,.tgn-in{height:56px;border-radius:22px;font-family:var(--font-body);font-size:17px;outline:none}.tgn-cc{width:100%;display:flex;align-items:center;justify-content:center;gap:7px;padding:0;cursor:pointer}.tgn-in{flex:1;min-width:0;padding:0 20px;letter-spacing:.04em;caret-color:#E4485B;-webkit-appearance:none;appearance:none}.tgn-in::placeholder{color:rgba(242,234,230,.4)}.tgn-in:focus{background-color:rgba(255,255,255,.08);border-color:rgba(240,86,110,.6);box-shadow:0 0 0 3px rgba(228,72,91,.14),inset 0 1px 0 rgba(255,255,255,.08)}.tgn-in.bad{border-color:rgba(240,86,110,.9)}.tgn-menu{position:absolute;top:64px;inset-inline-start:0;min-width:184px;z-index:30;padding:6px;display:flex;flex-direction:column;background:rgba(32,26,44,.96);-webkit-backdrop-filter:blur(30px);backdrop-filter:blur(30px);border:1px solid rgba(255,255,255,.14);border-radius:22px;box-shadow:0 18px 40px -18px #000}.tgn-menu > *{padding:12px 16px;border-radius:16px;font-family:var(--font-body);font-size:15px;color:#F2EAE6;cursor:pointer;white-space:pre}.tgn-menu > *:hover{background:rgba(255,255,255,.07)}.tgn-note{margin-top:14px;padding:16px 18px;border-radius:22px;background:rgba(228,72,91,.10);border:1px solid rgba(240,86,110,.35);display:flex;flex-direction:column;gap:6px;animation:tg-in .25s ease}.tgn-note b{font-family:var(--font-heading);font-weight:500;font-size:17.5px;color:#F2EAE6}.tgn-note span{font-family:var(--font-body);font-size:14px;line-height:1.5;color:rgba(242,234,230,.72)}.tgn-link{align-self:flex-start;margin-top:6px;height:40px;padding:0 18px;border-radius:999px;border:1px solid rgba(255,255,255,.34);background:transparent;color:#F2EAE6;font-family:var(--font-body);font-size:14px;cursor:pointer}.tgn-fine{font-family:var(--font-body);font-size:12.5px;line-height:1.5;color:rgba(242,234,230,.55);text-align:center;margin:14px 0 0;text-wrap:pretty}.tgn-cells{position:relative;margin-top:40px}.tgn-cellrow{display:flex;gap:10px;justify-content:center}.tgn-cell{width:54px;height:64px;border-radius:22px;display:grid;place-items:center;font-family:var(--font-heading);font-size:30px}.tgn-cell.full{background:rgba(228,72,91,.14);border-color:rgba(240,86,110,.45)}.tgn-cells:focus-within .tgn-cell.next{border-color:rgba(240,86,110,.6);background-color:rgba(255,255,255,.08);box-shadow:0 0 0 3px rgba(228,72,91,.14),inset 0 1px 0 rgba(255,255,255,.08)}.tgn-cells input{position:absolute;inset:0;width:100%;height:100%;opacity:0;border:0;background:transparent;font-size:28px;cursor:pointer}.tgn-acts{display:flex;justify-content:space-between;margin-top:12px}.tgn-acts button{background:none;border:0;padding:10px 4px;font-family:var(--font-body);font-size:13.5px;color:rgba(242,234,230,.72);cursor:pointer}.tgn-acts button[disabled]{color:rgba(242,234,230,.4);cursor:default}</style></helmet>' 'verification styles'
Once8 '          <sc-if value="{{ at.otp }}">' + "`n" + '            <div style="min-height:730px;display:flex;flex-direction:column;padding:var(--space-8) var(--space-6) var(--space-6);padding-block-end:70px;animation:tg-in .3s ease">' + "`n" + '              <img src="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20160%20100%22%20width%3D%22160%22%20height%3D%22100%22%3E%3Cdefs%3E%3ClinearGradient%20id%3D%22ka%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23FF7488%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%23E4485B%22%2F%3E%3C%2FlinearGradient%3E%3ClinearGradient%20id%3D%22kb%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23C7D4F2%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%237B93DC%22%2F%3E%3C%2FlinearGradient%3E%3Cmask%20id%3D%22km%22%3E%3Crect%20x%3D%220%22%20y%3D%220%22%20width%3D%22160%22%20height%3D%22100%22%20fill%3D%22%23fff%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22%23000%22%20stroke-width%3D%2212.3%22%2F%3E%3C%2Fmask%3E%3C%2Fdefs%3E%3Ccircle%20cx%3D%2262%22%20cy%3D%2247%22%20r%3D%2227%22%20fill%3D%22none%22%20stroke%3D%22url(%23ka)%22%20stroke-width%3D%227.5%22%20mask%3D%22url(%23km)%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22url(%23kb)%22%20stroke-width%3D%227.5%22%2F%3E%3C%2Fsvg%3E" alt="" style="display:block;width:44px;height:auto;margin-bottom:var(--space-2)">' + "`n" + '              <h2 style="font-size:39px;margin:0">Check your phone</h2>' + "`n" + '              <p style="font-size:18px;line-height:1.5;color:var(--color-accent-800);margin:var(--space-2) 0 0;max-width:300px;text-wrap:pretty">{{ otpBody }}</p>' + "`n" + '              <div style="flex:1;display:flex;flex-direction:column;justify-content:center">' + "`n" + '                <div style="width:100%;max-width:320px;margin:0 auto;display:flex;flex-direction:column;gap:var(--space-4)">' + "`n" + '                  <div style="position:relative">' + "`n" + '                    <div style="display:flex;gap:8px;justify-content:center">' + "`n" + '                      <sc-for list="{{ otpCells }}" as="c" hint-placeholder-count="5">' + "`n" + '                        <div style="flex:none">' + "`n" + '                          <sc-if value="{{ c.filled }}">' + "`n" + '                            <div style="width:52px;height:62px;border-radius:3px;background:rgba(228,72,91,.18);border:1px solid rgba(228,72,91,.45);display:grid;place-items:center;font-family:var(--font-heading);font-size:28px;color:#F2EAE6">{{ c.ch }}</div>' + "`n" + '                          </sc-if>' + "`n" + '                          <sc-if value="{{ c.empty }}">' + "`n" + '                            <div style="width:52px;height:62px;border-radius:3px;background:rgba(28,37,54,.07);border:1px solid rgba(242,234,230,.13);display:grid;place-items:center;font-family:var(--font-heading);font-size:28px;color:rgba(242,234,230,.66)">·</div>' + "`n" + '                          </sc-if>' + "`n" + '                        </div>' + "`n" + '                      </sc-for>' + "`n" + '                    </div>' + "`n" + '                    <input inputmode="numeric" maxlength="5" value="{{ form.otp }}" sc-camel-on-input="{{ set.otp }}" aria-label="5 digit code" style="position:absolute;inset:0;width:100%;height:100%;opacity:0;border:0;background:transparent;font-size:28px;text-align:center;cursor:pointer">' + "`n" + '                  </div>' + "`n" + '                  <p style="font-size:13px;color:color-mix(in srgb,var(--color-text) 66%,transparent);text-align:center;margin:0">Tap the boxes and type the code. Any 5 digits work in this prototype.</p>' + "`n" + '                </div>' + "`n" + '              </div>' + "`n" + '              <div style="width:100%;max-width:320px;margin:0 auto">' + "`n" + '                <button class="btn btn-primary btn-block tg-tap" style="height:50px" disabled="{{ otpNotReady }}" sc-camel-on-click="{{ verifyOtp }}">{{ otpCta }}</button>' + "`n" + '                <div style="display:flex;justify-content:space-between;margin-top:var(--space-3)">' + "`n" + '                  <button class="btn btn-ghost tg-tap" style="font-size:13px" sc-camel-on-click="{{ resendOtp }}">Send it again</button>' + "`n" + '                  <button class="btn btn-ghost tg-tap" style="font-size:13px" sc-camel-on-click="{{ go.login }}">Use another number</button>' + "`n" + '                </div>' + "`n" + '              </div>' + "`n" + '            </div>' + "`n" + '          </sc-if>' + "`n" + '' + "`n" + '' '          <sc-if value="{{ at.phone }}">' + "`n" + '            <div class="tgn" style="animation:tg-in .3s ease">' + "`n" + '              <div class="tgn-head"><img src="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20160%20100%22%20width%3D%22160%22%20height%3D%22100%22%3E%3Cdefs%3E%3ClinearGradient%20id%3D%22ka%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23FF7488%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%23E4485B%22%2F%3E%3C%2FlinearGradient%3E%3ClinearGradient%20id%3D%22kb%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23C7D4F2%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%237B93DC%22%2F%3E%3C%2FlinearGradient%3E%3Cmask%20id%3D%22km%22%3E%3Crect%20x%3D%220%22%20y%3D%220%22%20width%3D%22160%22%20height%3D%22100%22%20fill%3D%22%23fff%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22%23000%22%20stroke-width%3D%2212.3%22%2F%3E%3C%2Fmask%3E%3C%2Fdefs%3E%3Ccircle%20cx%3D%2262%22%20cy%3D%2247%22%20r%3D%2227%22%20fill%3D%22none%22%20stroke%3D%22url(%23ka)%22%20stroke-width%3D%227.5%22%20mask%3D%22url(%23km)%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22url(%23kb)%22%20stroke-width%3D%227.5%22%2F%3E%3C%2Fsvg%3E" alt=""><span class="tg-cased-up tgn-kicker">Together · your number</span></div>' + "`n" + '              <h2 class="tg-cased tgn-h">Your number</h2>' + "`n" + '              <p class="tg-cased tgn-lede">We text you a 5 digit code to make sure you''re real. One number holds one account, and it''s never shown on your profile.</p>' + "`n" + '              <div class="tgn-field">' + "`n" + '                <label class="tg-cased">Phone number</label>' + "`n" + '                <div class="tgn-row" dir="ltr">' + "`n" + '                  <div style="position:relative;flex:0 0 104px">' + "`n" + '                    <button type="button" class="tgn-cc tg-tap" sc-camel-on-click="{{ toggleCc }}"><span>{{ form.cc }}</span><svg width="11" height="11" sc-camel-view-box="0 0 24 24" fill="none" stroke="rgba(242,234,230,.6)" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"></path></svg></button>' + "`n" + '                    <sc-if value="{{ ccOpen }}">' + "`n" + '                      <div style="position:fixed;inset:0;z-index:29" sc-camel-on-click="{{ toggleCc }}"></div>' + "`n" + '                      <div class="tgn-menu">' + "`n" + '                        <sc-for list="{{ ccOpts }}" as="o" hint-placeholder-count="4">' + "`n" + '                          <div class="tg-tap" sc-camel-on-click="{{ o.pick }}">{{ o.label }}</div>' + "`n" + '                        </sc-for>' + "`n" + '                      </div>' + "`n" + '                    </sc-if>' + "`n" + '                  </div>' + "`n" + '                  <input class="tgn-in {{ phoneBad }}" inputmode="numeric" autocomplete="tel-national" aria-label="Phone number" value="{{ form.phone }}" sc-camel-on-input="{{ set.phone }}" placeholder="54 000 0000">' + "`n" + '                </div>' + "`n" + '              </div>' + "`n" + '              <sc-if value="{{ phoneTaken }}">' + "`n" + '                <div class="tgn-note" role="alert">' + "`n" + '                  <b class="tg-cased">This number already has an account.</b>' + "`n" + '                  <span class="tg-cased">Each number holds one account. Log in with it instead, or use a different number.</span>' + "`n" + '                  <button class="tgn-link tg-tap" sc-camel-on-click="{{ loginWithPhone }}">Log in with this number</button>' + "`n" + '                </div>' + "`n" + '              </sc-if>' + "`n" + '              <div style="flex:1;min-height:28px"></div>' + "`n" + '              <button class="btn btn-primary btn-block tg-imgbtn tg-imgbtn-primary tg-tap tg-cased" style="height:58px;font-family:var(--font-heading);font-size:18.5px" disabled="{{ phoneNotReady }}" sc-camel-on-click="{{ sendCode }}">{{ phoneCta }}</button>' + "`n" + '              <p class="tgn-fine">Standard text rates may apply. In this prototype, 54 123 4567 already has an account.</p>' + "`n" + '            </div>' + "`n" + '          </sc-if>' + "`n" + '' + "`n" + '          <sc-if value="{{ at.otp }}">' + "`n" + '            <div class="tgn" style="animation:tg-in .3s ease">' + "`n" + '              <div class="tgn-head"><img src="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20160%20100%22%20width%3D%22160%22%20height%3D%22100%22%3E%3Cdefs%3E%3ClinearGradient%20id%3D%22ka%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23FF7488%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%23E4485B%22%2F%3E%3C%2FlinearGradient%3E%3ClinearGradient%20id%3D%22kb%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23C7D4F2%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%237B93DC%22%2F%3E%3C%2FlinearGradient%3E%3Cmask%20id%3D%22km%22%3E%3Crect%20x%3D%220%22%20y%3D%220%22%20width%3D%22160%22%20height%3D%22100%22%20fill%3D%22%23fff%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22%23000%22%20stroke-width%3D%2212.3%22%2F%3E%3C%2Fmask%3E%3C%2Fdefs%3E%3Ccircle%20cx%3D%2262%22%20cy%3D%2247%22%20r%3D%2227%22%20fill%3D%22none%22%20stroke%3D%22url(%23ka)%22%20stroke-width%3D%227.5%22%20mask%3D%22url(%23km)%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22url(%23kb)%22%20stroke-width%3D%227.5%22%2F%3E%3C%2Fsvg%3E" alt=""><span class="tg-cased-up tgn-kicker">{{ otpKicker }}</span></div>' + "`n" + '              <h2 class="tg-cased tgn-h">Check your phone</h2>' + "`n" + '              <p class="tgn-lede">{{ otpBody }}</p>' + "`n" + '              <div class="tgn-cells" dir="ltr">' + "`n" + '                <div class="tgn-cellrow">' + "`n" + '                  <sc-for list="{{ otpCells }}" as="c" hint-placeholder-count="5">' + "`n" + '                    <div class="tgn-cell {{ c.cls }}">{{ c.ch }}</div>' + "`n" + '                  </sc-for>' + "`n" + '                </div>' + "`n" + '                <input inputmode="numeric" autocomplete="one-time-code" maxlength="5" value="{{ form.otp }}" sc-camel-on-input="{{ set.otp }}" aria-label="5 digit code">' + "`n" + '              </div>' + "`n" + '              <p class="tgn-fine" style="margin-top:18px">Any 5 digits work in this prototype.</p>' + "`n" + '              <div style="flex:1;min-height:28px"></div>' + "`n" + '              <button class="btn btn-primary btn-block tg-imgbtn tg-imgbtn-primary tg-tap" style="height:58px;font-family:var(--font-heading);font-size:18.5px" disabled="{{ otpNotReady }}" sc-camel-on-click="{{ verifyOtp }}">{{ otpCta }}</button>' + "`n" + '              <div class="tgn-acts">' + "`n" + '                <button class="tg-tap" disabled="{{ resendWait }}" sc-camel-on-click="{{ resendOtp }}">{{ resendLabel }}</button>' + "`n" + '                <button class="tg-tap" sc-camel-on-click="{{ otpBack }}">Use another number</button>' + "`n" + '              </div>' + "`n" + '            </div>' + "`n" + '          </sc-if>' + "`n" + '' + "`n" + '' 'your number and check your phone screens'
$doc = $doc.Replace('sc-camel-on-click="{{ go.basics }}">Create account</button>', 'sc-camel-on-click="{{ go.phone }}">Create account</button>')
Once8 '<button class="tg-sso tg-sso-apple tg-tap" sc-camel-on-click="{{ go.basics }}">' '<button class="tg-sso tg-sso-apple tg-tap" sc-camel-on-click="{{ go.phone }}">' 'apple asks for the number'
Once8 '<button class="tg-sso tg-sso-google tg-tap" sc-camel-on-click="{{ go.basics }}">' '<button class="tg-sso tg-sso-google tg-tap" sc-camel-on-click="{{ go.phone }}">' 'google asks for the number'
Once8 '    [''splash'',''auth'',''login'',''otp'',''basics'',' '    [''splash'',''auth'',''login'',''phone'',''otp'',''basics'',' 'phone screen exists'
Once8 '    go.subscription = () => this.nav(''subscription'');' + "`n" + '' '    go.subscription = () => this.nav(''subscription'');' + "`n" + '    go.phone = () => this.nav(''phone'', { phoneTaken: false, otpMode: ''signup'' });' + "`n" + '' 'go to your number'
Once8 'phone: e.target.value.replace(/[^0-9]/g, '''').slice(0, 10) }), loginError: false }),' 'phone: e.target.value.replace(/[^0-9]/g, '''').slice(0, 10) }), loginError: false, phoneTaken: false }),' 'typing clears taken'
Once8 '        if (v.length === 5) { clearTimeout(this._otp); this._otp = setTimeout(() => { this.nav(''discover'', { tab: ''discover'' }); }, 320); }' + "`n" + '' '        if (v.length === 5) { clearTimeout(this._otp); this._otp = setTimeout(() => this.otpDone(), 320); }' + "`n" + '' 'full code verifies'
Once8 '    if (this.state.screen === ''videocall'') p.callSecs = this.state.callSecs + 1;' + "`n" + '' '    if (this.state.screen === ''videocall'') p.callSecs = this.state.callSecs + 1;' + "`n" + '    if (this.state.screen === ''otp'' && Date.now() - (this.state.otpAt || 0) < 31000) p.otpNow = Date.now();' + "`n" + '' 'resend countdown ticks'
Once8 '  signOut() {' + "`n" + '' '  // one number, one account. Numbers that already hold an account live here; 54 123 4567 is the demo one.' + "`n" + '  numKey() { const f = this.state.form; return (f.cc || '''') + (f.phone || '''').replace(/[^0-9]/g, '''').replace(/^0+/, ''''); }' + "`n" + '  numbers() {' + "`n" + '    let a = [];' + "`n" + '    try { a = JSON.parse(localStorage.getItem(''tg-numbers'') || ''[]''); } catch (e) {}' + "`n" + '    return a.indexOf(''+972541234567'') < 0 ? a.concat(''+972541234567'') : a;' + "`n" + '  }' + "`n" + '  saveNumbers(a) { try { localStorage.setItem(''tg-numbers'', JSON.stringify(a)); } catch (e) {} }' + "`n" + '  forgetNumber() { const k = this.numKey(); this.saveNumbers(this.numbers().filter(n => n !== k)); }' + "`n" + '  phoneInfo() {' + "`n" + '    const f = this.state.form, d = (f.phone || '''').replace(/[^0-9]/g, ''''), n = d.replace(/^0+/, '''');' + "`n" + '    const pretty = n.length === 9 ? n.slice(0, 2) + '' '' + n.slice(2, 5) + '' '' + n.slice(5) : n;' + "`n" + '    return { digits: d.length, pretty: (f.cc || '''') + '' '' + pretty, left: Math.max(0, 30 - Math.floor((Date.now() - (this.state.otpAt || 0)) / 1000)) };' + "`n" + '  }' + "`n" + '  // a verified code: a new number becomes an account and goes on to the basics, a known one logs in' + "`n" + '  otpDone() {' + "`n" + '    clearTimeout(this._otp);' + "`n" + '    if (this.state.otpMode === ''signup'') {' + "`n" + '      const k = this.numKey(), a = this.numbers();' + "`n" + '      if (a.indexOf(k) < 0) this.saveNumbers(a.concat(k));' + "`n" + '      this.nav(''basics'', { phoneTaken: false });' + "`n" + '    } else this.nav(''discover'', { tab: ''discover'' });' + "`n" + '  }' + "`n" + '  signOut() {' + "`n" + '' 'number registry'
Once8 '    returning: (() =>' '    otpMode: ''login'', phoneTaken: false, otpAt: 0, otpNow: 0,' + "`n" + '    returning: (() =>' 'verification state'
Once8 '      otpBody: (st.form.phone ? ''We sent a 5 digit code to '' + st.form.cc + '' '' + st.form.phone + ''.'' : ''We sent you a 5 digit code.'') + '' It lands in a few seconds.'',' + "`n" + '      otpCells: [0, 1, 2, 3, 4].map(i => { const ch = (st.form.otp || '''')[i] || ''''; return { ch: ch, filled: !!ch, empty: !ch }; }),' + "`n" + '      otpReady: (st.form.otp || '''').length === 5,' + "`n" + '      otpNotReady: (st.form.otp || '''').length !== 5,' + "`n" + '      otpCta: (st.form.otp || '''').length === 5 ? ''Log in'' : ((st.form.otp || '''').length === 0 ? ''Enter the 5 digit code'' : ''Enter '' + (5 - (st.form.otp || '''').length) + '' more''),' + "`n" + '      verifyOtp: () => { if ((st.form.otp || '''').length === 5) { this.nav(''discover'', { tab: ''discover'' }); } else this.toast(''Enter all 5 digits''); },' + "`n" + '      resendOtp: () => { this.setState({ form: Object.assign({}, st.form, { otp: '''' }) }); this.toast(''New code sent''); },' + "`n" + '' '      otpBody: ''We sent a 5 digit code to '' + this.phoneInfo().pretty + ''. It lands in a few seconds.'',' + "`n" + '      otpKicker: st.otpMode === ''signup'' ? ''Together · your number'' : ''Together · log in'',' + "`n" + '      otpCells: [0, 1, 2, 3, 4].map(i => { const v = st.form.otp || '''', ch = v[i] || ''''; return { ch: ch, cls: ch ? ''full'' : (i === v.length ? ''next'' : '''') }; }),' + "`n" + '      otpReady: (st.form.otp || '''').length === 5,' + "`n" + '      otpNotReady: (st.form.otp || '''').length !== 5,' + "`n" + '      otpCta: (st.form.otp || '''').length === 5 ? (st.otpMode === ''signup'' ? ''Verify'' : ''Log in'') : ((st.form.otp || '''').length === 0 ? ''Enter the 5 digit code'' : ''Enter '' + (5 - (st.form.otp || '''').length) + '' more''),' + "`n" + '      verifyOtp: () => { if ((st.form.otp || '''').length === 5) this.otpDone(); else this.toast(''Enter all 5 digits''); },' + "`n" + '      resendWait: this.phoneInfo().left > 0,' + "`n" + '      resendLabel: this.phoneInfo().left > 0 ? ''Send again in 0:'' + String(this.phoneInfo().left).padStart(2, ''0'') : ''Send it again'',' + "`n" + '      resendOtp: () => { if (this.phoneInfo().left > 0) return; this.setState({ form: Object.assign({}, st.form, { otp: '''' }), otpAt: Date.now() }); this.toast(''New code sent''); },' + "`n" + '      otpBack: () => st.otpMode === ''signup'' ? this.nav(''phone'', { phoneTaken: false }) : this.nav(''login''),' + "`n" + '      phoneTaken: !!st.phoneTaken,' + "`n" + '      phoneBad: st.phoneTaken ? ''bad'' : '''',' + "`n" + '      phoneNotReady: this.phoneInfo().digits < 9,' + "`n" + '      phoneCta: this.phoneInfo().digits < 9 ? ''Enter your number'' : ''Send code'',' + "`n" + '      sendCode: () => {' + "`n" + '        if (this.phoneInfo().digits < 9) return;' + "`n" + '        if (this.numbers().indexOf(this.numKey()) >= 0) return this.setState({ phoneTaken: true });' + "`n" + '        this.nav(''otp'', { otpMode: ''signup'', otpAt: Date.now(), phoneTaken: false, form: Object.assign({}, st.form, { otp: '''' }) });' + "`n" + '      },' + "`n" + '      loginWithPhone: () => this.nav(''otp'', { otpMode: ''login'', otpAt: Date.now(), phoneTaken: false, form: Object.assign({}, st.form, { otp: '''' }) }),' + "`n" + '' 'verification values'
Once8 '        if (ph.length >= 9) { this.toast(''Code sent to '' + ph); return this.nav(''otp'', { form: Object.assign({}, st.form, { otp: '''' }) }); }' '        if (ph.length >= 9) return this.nav(''otp'', { otpMode: ''login'', otpAt: Date.now(), form: Object.assign({}, st.form, { otp: '''' }) });' 'login code'
Once8 'deleteAccount: () => { this.toast(''Account deleted. Signed out.''); this.signOut(); },' 'deleteAccount: () => { this.forgetNumber(); this.toast(''Account deleted. Signed out.''); this.signOut(); },' 'delete frees the number'
Once8 '      showSkip: [''auth'',''login'',''otp'',''basics'',''photos'',''verify'',''welcome''].indexOf(screen) >= 0,' '      showSkip: [''auth'',''login'',''otp'',''basics'',''photos'',''verify'',''welcome''].indexOf(screen) >= 0 && !(screen === ''otp'' && st.otpMode === ''signup''),' 'no skipping verification'
Once8 '      stillGround: [''splash'', ''auth'', ''login'', ''otp''].indexOf(screen)' '      stillGround: [''splash'', ''auth'', ''login'', ''phone'', ''otp''].indexOf(screen)' 'still ground'
Once8 '[''Sign up'',''auth''],[''Log in'',''login''],' '[''Sign up'',''auth''],[''Your number'',''phone''],[''Log in'',''login''],' 'screen list entry'
Once8 '    "Google": "Google",' + "`n" + '' '    "Google": "Google",' + "`n" + '    "Together · your number": "ביחד · המספר שלך",' + "`n" + '    "Together · log in": "ביחד · התחברות",' + "`n" + '    "Your number": "המספר שלך",' + "`n" + '    "We text you a 5 digit code to make sure you''re real. One number holds one account, and it''s never shown on your profile.": "נשלח אליכם קוד בן 5 ספרות כדי לוודא שאתם אמיתיים. כל מספר מחזיק חשבון אחד, והוא אף פעם לא מוצג בפרופיל.",' + "`n" + '    "Phone number": "מספר טלפון",' + "`n" + '    "Enter your number": "הזינו את המספר",' + "`n" + '    "Send code": "שליחת קוד",' + "`n" + '    "This number already has an account.": "למספר הזה כבר יש חשבון.",' + "`n" + '    "Each number holds one account. Log in with it instead, or use a different number.": "כל מספר מחזיק חשבון אחד. אפשר להתחבר איתו, או להשתמש במספר אחר.",' + "`n" + '    "Log in with this number": "התחברות עם המספר הזה",' + "`n" + '    "Standard text rates may apply. In this prototype, 54 123 4567 already has an account.": "ייתכנו עלויות הודעה רגילות. באב־טיפוס הזה, למספר 54 123 4567 כבר יש חשבון.",' + "`n" + '    "Check your phone": "בדקו את הטלפון",' + "`n" + '    "Any 5 digits work in this prototype.": "כל 5 ספרות עובדות באב־טיפוס הזה.",' + "`n" + '    "Verify": "אימות",' + "`n" + '    "Enter the 5 digit code": "הזינו את הקוד בן 5 הספרות",' + "`n" + '    "Send it again": "שליחה חוזרת",' + "`n" + '    "Use another number": "מספר אחר",' + "`n" + '' 'hebrew'
# welcome back uses the same glass fields as the number step
Once8 '          <sc-if value="{{ at.login }}">' + "`n" + '            <div style="min-height:730px;display:flex;flex-direction:column;padding:var(--space-8) var(--space-6) var(--space-6);padding-block-end:70px;animation:tg-in .3s ease">' + "`n" + '              <img src="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20160%20100%22%20width%3D%22160%22%20height%3D%22100%22%3E%3Cdefs%3E%3ClinearGradient%20id%3D%22ka%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23FF7488%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%23E4485B%22%2F%3E%3C%2FlinearGradient%3E%3ClinearGradient%20id%3D%22kb%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23C7D4F2%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%237B93DC%22%2F%3E%3C%2FlinearGradient%3E%3Cmask%20id%3D%22km%22%3E%3Crect%20x%3D%220%22%20y%3D%220%22%20width%3D%22160%22%20height%3D%22100%22%20fill%3D%22%23fff%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22%23000%22%20stroke-width%3D%2212.3%22%2F%3E%3C%2Fmask%3E%3C%2Fdefs%3E%3Ccircle%20cx%3D%2262%22%20cy%3D%2247%22%20r%3D%2227%22%20fill%3D%22none%22%20stroke%3D%22url(%23ka)%22%20stroke-width%3D%227.5%22%20mask%3D%22url(%23km)%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22url(%23kb)%22%20stroke-width%3D%227.5%22%2F%3E%3C%2Fsvg%3E" alt="" style="display:block;width:44px;height:auto;margin-bottom:var(--space-2)">' + "`n" + '              <h2 class="tg-cased" style="font-family:var(--font-heading);font-size:39px;margin:0">Welcome back</h2>' + "`n" + '              <p class="tg-cased" style="font-family:var(--font-body);font-size:15.5px;line-height:1.5;color:rgba(242,234,230,.68);margin:var(--space-2) 0 0;max-width:300px;text-wrap:pretty">Log in to start getting Together again.</p>' + "`n" + '              <div style="flex:1;display:flex;flex-direction:column;justify-content:center">' + "`n" + '                <div style="width:100%;max-width:320px;margin:0 auto;display:flex;flex-direction:column;gap:var(--space-3)">' + "`n" + '                  <div class="field" style="display:flex;flex-direction:column;gap:6px">' + "`n" + '                    <label class="tg-cased" style="font-family:var(--font-body);font-size:14px;color:rgba(242,234,230,.6)">Email</label>' + "`n" + '                    <input class="tg-vinput {{ emailHasVal }}" style="height:46px;font-family:var(--font-body);font-size:15px" value="{{ form.email }}" autocapitalize="none" autocorrect="off" spellcheck="false" sc-camel-on-input="{{ set.email }}" sc-camel-on-focus="{{ emailFocus }}" sc-camel-on-blur="{{ emailBlur }}" placeholder="you@example.com">' + "`n" + '                  </div>' + "`n" + '                  <div class="field" style="display:flex;flex-direction:column;gap:6px">' + "`n" + '                    <label class="tg-cased" style="font-family:var(--font-body);font-size:14px;color:rgba(242,234,230,.6)">Password</label>' + "`n" + '                    <input class="tg-vinput {{ pwHasVal }}" type="password" style="height:46px;font-family:var(--font-body);font-size:15px" value="{{ form.pw }}" sc-camel-on-input="{{ set.pw }}" sc-camel-on-focus="{{ pwFocus }}" sc-camel-on-blur="{{ pwBlur }}" placeholder="Your password">' + "`n" + '                  </div>' + "`n" + '                  <div style="display:flex;align-items:center;gap:var(--space-3);margin:2px 0;color:color-mix(in srgb,var(--color-text) 66%,transparent);font-size:13px">' + "`n" + '                    <div style="flex:1;height:1px;background:var(--color-divider)"></div><span>or</span><div style="flex:1;height:1px;background:var(--color-divider)"></div>' + "`n" + '                  </div>' + "`n" + '                  <div class="field" style="display:flex;flex-direction:column;gap:6px">' + "`n" + '                    <label class="tg-cased" style="font-family:var(--font-body);font-size:14px;color:rgba(242,234,230,.6)">Phone number</label>' + "`n" + '                    <div style="display:flex;gap:8px">' + "`n" + '                      <div style="position:relative;flex:0 0 108px">' + "`n" + '                        <button type="button" class="tg-tap tg-glass {{ ccLitCls }}" style="width:100%;height:46px;border-radius:2px;display:flex;align-items:center;justify-content:center;gap:6px;padding:0;color:#F2EAE6;font-family:var(--font-body);font-size:15px;cursor:pointer" sc-camel-on-click="{{ toggleCc }}">' + "`n" + '                          <span>{{ form.cc }}</span>' + "`n" + '                          <svg width="11" height="11" sc-camel-view-box="0 0 24 24" fill="none" stroke="rgba(28,37,54,.55)" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"></path></svg>' + "`n" + '                        </button>' + "`n" + '                        <sc-if value="{{ ccOpen }}">' + "`n" + '                          <div style="position:absolute;inset:0;z-index:29" sc-camel-on-click="{{ toggleCc }}"></div>' + "`n" + '                          <div style="position:absolute;top:54px;inset-inline-start:0;min-width:168px;z-index:30;background:linear-gradient(165deg,rgba(52,42,62,.96),rgba(32,26,44,.94));backdrop-filter:blur(34px) saturate(1.3);border:1px solid rgba(242,234,230,.20);border-radius:3px;padding:6px;display:flex;flex-direction:column;gap:2px;box-shadow:inset 0 1px 0 rgba(28,37,54,.14),0 24px 54px -14px rgba(0,0,0,.75)">' + "`n" + '                            <sc-for list="{{ ccOpts }}" as="o" hint-placeholder-count="4">' + "`n" + '                              <div class="tg-tap" style="padding:11px 14px;border-radius:3px;font-size:15px;color:#F2EAE6;cursor:pointer" sc-camel-on-click="{{ o.pick }}">{{ o.label }}</div>' + "`n" + '                            </sc-for>' + "`n" + '                          </div>' + "`n" + '                        </sc-if>' + "`n" + '                      </div>' + "`n" + '                      <input class="tg-vinput {{ phoneHasVal }}" inputmode="numeric" style="height:46px;flex:1;min-width:0;font-family:var(--font-body);font-size:15px" value="{{ form.phone }}" sc-camel-on-input="{{ set.phone }}" sc-camel-on-focus="{{ phoneFocus }}" sc-camel-on-blur="{{ phoneBlur }}" placeholder="54 000 0000">' + "`n" + '                    </div>' + "`n" + '                    <span class="tg-cased" style="font-family:var(--font-body);font-size:12.5px;color:rgba(242,234,230,.66)">We text you a 5 digit code instead of a password.</span>' + "`n" + '                  </div>' + "`n" + '                  <sc-if value="{{ loginError }}">' + "`n" + '                    <p style="font-size:13px;color:var(--color-accent-800);background:var(--color-accent-100);padding:10px 14px;border-radius:var(--radius-md);margin:0">Enter your email and password, or your phone number.</p>' + "`n" + '                  </sc-if>' + "`n" + '                </div>' + "`n" + '              </div>' + "`n" + '              <div style="width:100%;max-width:320px;margin:0 auto;margin-top:auto;padding-top:var(--space-8)">' + "`n" + '                <button class="btn btn-primary btn-block tg-imgbtn tg-imgbtn-primary tg-tap tg-cased" style="height:58px;font-family:var(--font-heading);font-size:18.5px" sc-camel-on-click="{{ doLogin }}">Log in</button>' + "`n" + '                <div style="display:flex;justify-content:space-between;margin-top:var(--space-3)">' + "`n" + '                  <button class="btn btn-ghost tg-tap tg-cased" style="font-family:var(--font-body);font-size:13px" sc-camel-on-click="{{ go.forgot }}">Forgot password</button>' + "`n" + '                  <button class="btn btn-ghost tg-tap tg-cased" style="font-family:var(--font-body);font-size:13px" sc-camel-on-click="{{ go.phone }}">Create account</button>' + "`n" + '                </div>' + "`n" + '              </div>' + "`n" + '            </div>' + "`n" + '          </sc-if>' + "`n" + '' + "`n" + '' '          <sc-if value="{{ at.login }}">' + "`n" + '            <div class="tgn" style="animation:tg-in .3s ease">' + "`n" + '              <div class="tgn-head"><img src="data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20160%20100%22%20width%3D%22160%22%20height%3D%22100%22%3E%3Cdefs%3E%3ClinearGradient%20id%3D%22ka%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23FF7488%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%23E4485B%22%2F%3E%3C%2FlinearGradient%3E%3ClinearGradient%20id%3D%22kb%22%20x1%3D%220%22%20y1%3D%220%22%20x2%3D%220%22%20y2%3D%221%22%3E%3Cstop%20offset%3D%220%22%20stop-color%3D%22%23C7D4F2%22%2F%3E%3Cstop%20offset%3D%221%22%20stop-color%3D%22%237B93DC%22%2F%3E%3C%2FlinearGradient%3E%3Cmask%20id%3D%22km%22%3E%3Crect%20x%3D%220%22%20y%3D%220%22%20width%3D%22160%22%20height%3D%22100%22%20fill%3D%22%23fff%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22%23000%22%20stroke-width%3D%2212.3%22%2F%3E%3C%2Fmask%3E%3C%2Fdefs%3E%3Ccircle%20cx%3D%2262%22%20cy%3D%2247%22%20r%3D%2227%22%20fill%3D%22none%22%20stroke%3D%22url(%23ka)%22%20stroke-width%3D%227.5%22%20mask%3D%22url(%23km)%22%2F%3E%3Ccircle%20cx%3D%2298%22%20cy%3D%2253%22%20r%3D%2231%22%20fill%3D%22none%22%20stroke%3D%22url(%23kb)%22%20stroke-width%3D%227.5%22%2F%3E%3C%2Fsvg%3E" alt=""><span class="tg-cased-up tgn-kicker">Together · log in</span></div>' + "`n" + '              <h2 class="tg-cased tgn-h">Welcome back</h2>' + "`n" + '              <p class="tg-cased tgn-lede">Log in to start getting Together again.</p>' + "`n" + '              <div class="tgn-field">' + "`n" + '                <label class="tg-cased">Email</label>' + "`n" + '                <input class="tgn-in" type="email" autocomplete="email" autocapitalize="none" autocorrect="off" spellcheck="false" value="{{ form.email }}" sc-camel-on-input="{{ set.email }}" placeholder="you@example.com">' + "`n" + '              </div>' + "`n" + '              <div class="tgn-field tight">' + "`n" + '                <label class="tg-cased">Password</label>' + "`n" + '                <input class="tgn-in" type="password" autocomplete="current-password" value="{{ form.pw }}" sc-camel-on-input="{{ set.pw }}" placeholder="Your password">' + "`n" + '              </div>' + "`n" + '              <div class="tgn-or"><i></i><span>or</span><i></i></div>' + "`n" + '              <div class="tgn-field flush">' + "`n" + '                <label class="tg-cased">Phone number</label>' + "`n" + '                <div class="tgn-row" dir="ltr">' + "`n" + '                  <div style="position:relative;flex:0 0 104px">' + "`n" + '                    <button type="button" class="tgn-cc tg-tap" sc-camel-on-click="{{ toggleCc }}"><span>{{ form.cc }}</span><svg width="11" height="11" sc-camel-view-box="0 0 24 24" fill="none" stroke="rgba(242,234,230,.6)" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"></path></svg></button>' + "`n" + '                    <sc-if value="{{ ccOpen }}">' + "`n" + '                      <div style="position:fixed;inset:0;z-index:29" sc-camel-on-click="{{ toggleCc }}"></div>' + "`n" + '                      <div class="tgn-menu">' + "`n" + '                        <sc-for list="{{ ccOpts }}" as="o" hint-placeholder-count="4">' + "`n" + '                          <div class="tg-tap" sc-camel-on-click="{{ o.pick }}">{{ o.label }}</div>' + "`n" + '                        </sc-for>' + "`n" + '                      </div>' + "`n" + '                    </sc-if>' + "`n" + '                  </div>' + "`n" + '                  <input class="tgn-in" inputmode="numeric" autocomplete="tel-national" aria-label="Phone number" value="{{ form.phone }}" sc-camel-on-input="{{ set.phone }}" placeholder="54 000 0000">' + "`n" + '                </div>' + "`n" + '                <span class="tg-cased tgn-hint">We text you a 5 digit code instead of a password.</span>' + "`n" + '              </div>' + "`n" + '              <sc-if value="{{ loginError }}">' + "`n" + '                <div class="tgn-note" role="alert"><span class="tg-cased">Enter your email and password, or your phone number.</span></div>' + "`n" + '              </sc-if>' + "`n" + '              <div style="flex:1;min-height:28px"></div>' + "`n" + '              <button class="btn btn-primary btn-block tg-imgbtn tg-imgbtn-primary tg-tap tg-cased" style="height:58px;font-family:var(--font-heading);font-size:18.5px" sc-camel-on-click="{{ doLogin }}">Log in</button>' + "`n" + '              <div class="tgn-acts">' + "`n" + '                <button class="tg-tap tg-cased" sc-camel-on-click="{{ go.forgot }}">Forgot password</button>' + "`n" + '                <button class="tg-tap tg-cased" sc-camel-on-click="{{ go.phone }}">Create account</button>' + "`n" + '              </div>' + "`n" + '            </div>' + "`n" + '          </sc-if>' + "`n" + '' + "`n" + '' 'welcome back in the glass fields'
Once8 '.tgn-acts button[disabled]{color:rgba(242,234,230,.4);cursor:default}</style>' '.tgn-acts button[disabled]{color:rgba(242,234,230,.4);cursor:default}.tgn-field > .tgn-in{flex:none;width:100%}.tgn-field.tight{margin-top:16px}.tgn-field.flush{margin-top:0}.tgn-or{display:flex;align-items:center;gap:16px;margin:22px 0 18px}.tgn-or i{flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(228,72,91,.45))}.tgn-or i:last-child{background:linear-gradient(90deg,rgba(228,72,91,.45),transparent)}.tgn-or span{font-family:var(--font-heading);font-style:italic;font-size:14.5px;color:rgba(242,234,230,.66)}.tgn-hint{font-family:var(--font-body);font-size:12.5px;line-height:1.5;color:rgba(242,234,230,.55)}</style>' 'login field styles'
# the bottom fifth of the profile photo fades to the dark ground
Once8 '</helmet>' '<style>.tgd-hero{box-shadow:none !important}.tgd-hero::after{display:block;top:auto;bottom:-24px;height:170px;-webkit-backdrop-filter:none;backdrop-filter:none;-webkit-mask-image:none;mask-image:none;background:linear-gradient(180deg,rgba(9,5,11,0) 0%,rgba(9,5,11,.34) 45%,rgba(9,5,11,.52) 72%,rgba(9,5,11,.46) 86%,rgba(9,5,11,0) 100%)}.tgd-hero-img,.tgd-hero-shade{-webkit-mask-image:linear-gradient(180deg,#000 0%,#000 72%,rgba(0,0,0,.62) 79%,rgba(0,0,0,.26) 87%,rgba(0,0,0,.07) 94%,rgba(0,0,0,0) 100%) !important;mask-image:linear-gradient(180deg,#000 0%,#000 72%,rgba(0,0,0,.62) 79%,rgba(0,0,0,.26) 87%,rgba(0,0,0,.07) 94%,rgba(0,0,0,0) 100%) !important}</style></helmet>' 'profile photo dark fade'
# edit profile: one compact bar, and View opens exactly like Discover
Once8 '              <div class="ep-bar">' + "`n" + '                <button class="btn btn-icon tg-tap" sc-camel-on-click="{{ ep.back }}" aria-label="Back">' '              <div class="ep-bar ep-bar-seg">' + "`n" + '                <button class="btn btn-icon tg-tap" sc-camel-on-click="{{ ep.back }}" aria-label="Back">' 'edit profile bar'
Once8 '                <span class="ep-title">Edit profile</span>' + "`n" + '                <button class="ep-done tg-tap" sc-camel-on-click="{{ ep.back }}">Done</button>' + "`n" + '              </div>' + "`n" + '              <div class="ep-tabs">' + "`n" + '                <button class="tg-tap {{ ep.segEdit }}" sc-camel-on-click="{{ ep.toEdit }}">Edit</button>' + "`n" + '                <button class="tg-tap {{ ep.segView }}" sc-camel-on-click="{{ ep.toView }}">View</button>' + "`n" + '              </div>' + "`n" + '' '                <div class="ep-seg" role="tablist" aria-label="Edit profile">' + "`n" + '                  <div class="ep-seg-in">' + "`n" + '                    <button class="tg-tap {{ ep.segEdit }}" role="tab" sc-camel-on-click="{{ ep.toEdit }}">Edit</button>' + "`n" + '                    <button class="tg-tap {{ ep.segView }}" role="tab" sc-camel-on-click="{{ ep.toView }}">View</button>' + "`n" + '                  </div>' + "`n" + '                </div>' + "`n" + '                <button class="ep-done tg-tap" sc-camel-on-click="{{ ep.back }}">Done</button>' + "`n" + '              </div>' + "`n" + '' 'edit view toggle in the bar'
Once8 '                  <p class="ep-viewnote">This is exactly how people see you in Discover.</p>' + "`n" + '' '' 'view shows only the profile'
Once8 '</helmet>' '<style>.ep .ep-bar.ep-bar-seg{height:43px;box-sizing:border-box;padding:0 6px !important;display:flex;align-items:center;gap:4px}.ep-bar-seg .btn-icon{flex:none}.ep-seg{flex:1;display:flex;justify-content:center;min-width:0}.ep-seg-in{display:inline-flex;padding:3px;gap:2px;border-radius:999px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.12)}.ep-seg-in button{height:28px;padding:0 18px;border:0;border-radius:999px;background:none;cursor:pointer;font-family:var(--font-body);font-size:13.5px;color:rgba(242,234,230,.62);transition:background-color .2s ease,color .2s ease,box-shadow .2s ease}.ep-seg-in button.on{background:rgba(228,72,91,.22);color:#F2EAE6;box-shadow:inset 0 0 0 1px rgba(240,86,110,.55)}.ep-bar-seg .ep-done{flex:none;padding:8px 10px}.ep .ep-view{padding-top:0}.ep .ep-view > .tgd-hero{margin-inline:-16px !important}.ep .ep-body{padding-top:8px}.ep .ep-counters{display:flex !important;gap:5px}.ep .ep-counters > span{flex:1 1 auto;display:flex !important;flex-direction:row !important;align-items:center !important;justify-content:center !important;gap:4px !important;height:30px !important;min-height:0 !important;padding:0 8px !important;border-radius:999px !important;white-space:nowrap;line-height:1 !important;font-size:12.5px !important}.ep .ep-counters b{font-size:13px;line-height:1}.ep .ep-hint{margin:7px 0 7px;white-space:nowrap}</style></helmet>' 'compact edit profile header'
Once8 '<span>Tap to edit · Hold a square or a card, then drag to move</span>' '<span>Tap to edit · Hold and drag to move</span>' 'shorter edit hint'
Once8 '      const counters = kinds.map(k => ({ label: NAME[k], count:' '      const counters = kinds.map(k => ({ label: (!he && k === ''voice'') ? ''Voice'' : NAME[k], count:' 'short voice counter'
# preferences: a way back, and changes kept on the device
Once8 '    prefs: { ageMin: 26, ageMax: 36, dist: 15, seek: [''Women''], intent: ''A relationship'', kids: ''Any'', strictDist: true, strictAge: false, verifiedOnly: false },' + "`n" + '' '    // preferences are kept on the device, so what you set is still there next time' + "`n" + '    prefs: Object.assign({ ageMin: 26, ageMax: 36, dist: 15, seek: [''Women''], intent: ''A relationship'', kids: ''Any'', strictDist: true, strictAge: false, verifiedOnly: false },' + "`n" + '      (() => { try { return JSON.parse(localStorage.getItem(''tg-prefs'') || ''{}'') || {}; } catch (e) { return {}; } })()),' + "`n" + '    prefsBack: null,' + "`n" + '' 'saved preferences load'
Once8 '    this._prefSave = setTimeout(() => this.setState({ prefsDirty: false, prefsSaved: true }), 650);' + "`n" + '' '    this._prefSave = setTimeout(() => {' + "`n" + '      try { localStorage.setItem(''tg-prefs'', JSON.stringify(this.state.prefs)); } catch (e) {}' + "`n" + '      this.setState({ prefsDirty: false, prefsSaved: true });' + "`n" + '    }, 650);' + "`n" + '' 'preferences save themselves'
Once8 '  nav(screen, extra) { this.setState(Object.assign({ screen, overlay: null }, screen === ''discover'' ? { cbHide: false } : {}, extra || {})); }' + "`n" + '  tabTo(tab) { this.setState({ tab, screen: tab, overlay: null, cbHide: false }); }' + "`n" + '' '  // preferences remember the page they were opened from, for the back arrow' + "`n" + '  backFor(screen) { return screen === ''prefs'' && this.state.screen !== ''prefs'' ? { prefsBack: this.state.screen } : {}; }' + "`n" + '  nav(screen, extra) { this.setState(Object.assign({ screen, overlay: null }, screen === ''discover'' ? { cbHide: false } : {}, this.backFor(screen), extra || {})); }' + "`n" + '  tabTo(tab) { this.setState(Object.assign({ tab, screen: tab, overlay: null, cbHide: false }, this.backFor(tab))); }' + "`n" + '' 'preferences remember where they came from'
Once8 '      stillGround: [''splash'', ''auth'', ''login'', ''phone'', ''otp''].indexOf(screen) >= 0 ? ''on'' : '''',' + "`n" + '' '      stillGround: [''splash'', ''auth'', ''login'', ''phone'', ''otp''].indexOf(screen) >= 0 ? ''on'' : '''',' + "`n" + '      prefsHasBack: !!st.prefsBack,' + "`n" + '      prefsGoBack: () => { const b = st.prefsBack || ''discover''; if (tabScreens.indexOf(b) >= 0) this.tabTo(b); else this.nav(b); },' + "`n" + '' 'preferences back values'
Once8 '              <div style="display:flex;align-items:baseline;justify-content:space-between;gap:12px">' + "`n" + '                <span style="font-family:var(--font-heading);font-size:22px">Preferences</span>' '              <div style="display:flex;align-items:center;justify-content:space-between;gap:10px">' + "`n" + '                <sc-if value="{{ prefsHasBack }}"><button class="btn btn-icon tg-tap tgp-back" sc-camel-on-click="{{ prefsGoBack }}" aria-label="Back"><svg width="19" height="19" sc-camel-view-box="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg></button></sc-if>' + "`n" + '                <span style="font-family:var(--font-heading);font-size:22px;flex:1;min-width:0">Preferences</span>' 'preferences back arrow'
Once8 'deleteAccount: () => { this.forgetNumber();' 'deleteAccount: () => { this.forgetNumber(); try { localStorage.removeItem(''tg-prefs''); } catch (e) {}' 'delete forgets preferences'
Once8 '</helmet>' '<style>.tgp-back{flex:none;margin-inline-start:-5px}.card[data-prem]{margin-top:26px !important}[dir=rtl] .tgp-back svg{transform:scaleX(-1)}</style></helmet>' 'preferences back arrow style'
# profile: the premium offer waits at the bottom
Once8 '{{ profileMenu }}" as="item" hint-placeholder-count="6">' + "`n" + '                  <button class="tg-tap tg-row" style="display:flex;align-items:center;justify-content:space-between;width:100%;background:transparent;border:0;border-bottom:1px solid var(--color-divider);padding:16px 8px;font:400 15px var(--font-body);color:var(--color-text);cursor:pointer" sc-camel-on-click="{{ item.onClick }}">' + "`n" + '                    <span>{{ item.label }}</span>' + "`n" + '                    <span style="font-size:13px;color:var(--color-accent-800)">{{ item.meta }}</span>' + "`n" + '                  </button>' + "`n" + '                </sc-for>' + "`n" + '              </div>' + "`n" + '            </div>' + "`n" + '          </sc-if>' '{{ profileMenu }}" as="item" hint-placeholder-count="6">' + "`n" + '                  <button class="tg-tap tg-row" style="display:flex;align-items:center;justify-content:space-between;width:100%;background:transparent;border:0;border-bottom:1px solid var(--color-divider);padding:16px 8px;font:400 15px var(--font-body);color:var(--color-text);cursor:pointer" sc-camel-on-click="{{ item.onClick }}">' + "`n" + '                    <span>{{ item.label }}</span>' + "`n" + '                    <span style="font-size:13px;color:var(--color-accent-800)">{{ item.meta }}</span>' + "`n" + '                  </button>' + "`n" + '                </sc-for>' + "`n" + '              </div>' + "`n" + '              <sc-if value="{{ notPremium }}">' + "`n" + '                <div data-prem="1" class="card elev-md" style="background:var(--tg-deep);color:var(--tg-deep-ink);gap:var(--space-3);margin-top:var(--space-5);border:0">' + "`n" + '                  <span style="font-size:12.5px;letter-spacing:.1em;text-transform:uppercase;color:var(--tg-deep-sub)">Premium</span>' + "`n" + '                  <h3 style="font-size:24px;margin:0;color:var(--tg-deep-ink)">Three slots instead of one</h3>' + "`n" + '                  <p style="font-size:13.5px;margin:0;opacity:.85;text-wrap:pretty">See who liked you, a ring a day, video dates included, and undo an ending for free.</p>' + "`n" + '                  <button class="btn tg-tap" style="background:var(--tg-deep-ink);color:var(--tg-deep);height:46px;margin-top:6px" sc-camel-on-click="{{ openUpgrade.generic }}">{{ priceMonthly }}</button>' + "`n" + '                  <div style="display:flex;flex-direction:column;gap:8px;margin-top:2px">' + "`n" + '                <sc-if value="{{ couponClosed }}" hint-placeholder-val="{{ true }}">' + "`n" + '                  <button class="tg-tap" style="align-self:center;background:transparent;border:0;padding:5px 4px;font:400 12.5px var(--font-body);color:inherit;opacity:.72;text-decoration:underline;text-underline-offset:3px;cursor:pointer" sc-camel-on-click="{{ openCoupon }}">Have a discount code?</button>' + "`n" + '                </sc-if>' + "`n" + '                <sc-if value="{{ couponOpen }}">' + "`n" + '                  <div style="display:flex;gap:8px">' + "`n" + '                    <input style="flex:1;min-width:0;height:42px;box-sizing:border-box;border-radius:999px;padding:0 16px;font:400 13.5px var(--font-body);letter-spacing:.1em;text-transform:uppercase;color:inherit;background:color-mix(in srgb,currentColor 9%,transparent);border:1px solid color-mix(in srgb,currentColor 26%,transparent)" value="{{ couponCode }}" autocapitalize="characters" autocorrect="off" spellcheck="false" sc-camel-on-input="{{ set.coupon }}" placeholder="ENTER CODE">' + "`n" + '                    <button class="tg-tap" style="flex:none;height:42px;padding:0 18px;border-radius:999px;border:0;font:600 13px var(--font-body);color:inherit;background:color-mix(in srgb,currentColor 18%,transparent);cursor:pointer" sc-camel-on-click="{{ applyCoupon }}">Apply</button>' + "`n" + '                  </div>' + "`n" + '                </sc-if>' + "`n" + '                <sc-if value="{{ couponNote }}">' + "`n" + '                  <div class="tg-tap" style="text-align:center;font-size:12.5px;line-height:1.4;opacity:.92;cursor:pointer" sc-camel-on-click="{{ openCoupon }}">{{ couponNote }}</div>' + "`n" + '                </sc-if>' + "`n" + '              </div>' + "`n" + '                </div>' + "`n" + '              </sc-if>' + "`n" + '            </div>' + "`n" + '          </sc-if>' 'premium offer after the menu'
Once8 '              <sc-if value="{{ notPremium }}">' + "`n" + '                <div data-prem="1" class="card elev-md" style="background:var(--tg-deep);color:var(--tg-deep-ink);gap:var(--space-3);margin-bottom:var(--space-4);border:0">' + "`n" + '                  <span style="font-size:12.5px;letter-spacing:.1em;text-transform:uppercase;color:var(--tg-deep-sub)">Premium</span>' + "`n" + '                  <h3 style="font-size:24px;margin:0;color:var(--tg-deep-ink)">Three slots instead of one</h3>' + "`n" + '                  <p style="font-size:13.5px;margin:0;opacity:.85;text-wrap:pretty">See who liked you, a ring a day, video dates included, and undo an ending for free.</p>' + "`n" + '                  <button class="btn tg-tap" style="background:var(--tg-deep-ink);color:var(--tg-deep);height:46px;margin-top:6px" sc-camel-on-click="{{ openUpgrade.generic }}">{{ priceMonthly }}</button>' + "`n" + '                  <div style="display:flex;flex-direction:column;gap:8px;margin-top:2px">' + "`n" + '                <sc-if value="{{ couponClosed }}" hint-placeholder-val="{{ true }}">' + "`n" + '                  <button class="tg-tap" style="align-self:center;background:transparent;border:0;padding:5px 4px;font:400 12.5px var(--font-body);color:inherit;opacity:.72;text-decoration:underline;text-underline-offset:3px;cursor:pointer" sc-camel-on-click="{{ openCoupon }}">Have a discount code?</button>' + "`n" + '                </sc-if>' + "`n" + '                <sc-if value="{{ couponOpen }}">' + "`n" + '                  <div style="display:flex;gap:8px">' + "`n" + '                    <input style="flex:1;min-width:0;height:42px;box-sizing:border-box;border-radius:999px;padding:0 16px;font:400 13.5px var(--font-body);letter-spacing:.1em;text-transform:uppercase;color:inherit;background:color-mix(in srgb,currentColor 9%,transparent);border:1px solid color-mix(in srgb,currentColor 26%,transparent)" value="{{ couponCode }}" autocapitalize="characters" autocorrect="off" spellcheck="false" sc-camel-on-input="{{ set.coupon }}" placeholder="ENTER CODE">' + "`n" + '                    <button class="tg-tap" style="flex:none;height:42px;padding:0 18px;border-radius:999px;border:0;font:600 13px var(--font-body);color:inherit;background:color-mix(in srgb,currentColor 18%,transparent);cursor:pointer" sc-camel-on-click="{{ applyCoupon }}">Apply</button>' + "`n" + '                  </div>' + "`n" + '                </sc-if>' + "`n" + '                <sc-if value="{{ couponNote }}">' + "`n" + '                  <div class="tg-tap" style="text-align:center;font-size:12.5px;line-height:1.4;opacity:.92;cursor:pointer" sc-camel-on-click="{{ openCoupon }}">{{ couponNote }}</div>' + "`n" + '                </sc-if>' + "`n" + '              </div>' + "`n" + '                </div>' + "`n" + '              </sc-if>' + "`n" + '' '' 'premium offer leaves the top'
